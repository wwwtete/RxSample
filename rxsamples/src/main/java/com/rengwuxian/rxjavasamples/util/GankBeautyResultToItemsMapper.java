...
public class GankBeautyResultToItemsMapper implements Func1<GankBeautyResult, List<Item>> {
    ...
    public List<Item> call(GankBeautyResult gankBeautyResult) {
        ...
        final SimpleDateFormat inputFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SS'Z'");
        final SimpleDateFormat outputFormat = new SimpleDateFormat("yy/MM/dd HH:mm:ss");
